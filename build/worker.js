                    ...
                    if (e.data.action === 'initialize' && e.data.timestamp === timestamp) {
                        if (e.data.detail === true) {
                            db.settings.migrations.forEach(function (schema) {
                                Object.defineProperty(_models, schema.name, {
                                    get: function get() {
...
var Model = function (_Builder) {
    _inherits(Model, _Builder);
    ...
    function Model(db, idbKey, modelName, primary, Q) {
        ...
        _this.tables = [_this.name];
        _this.idbKey = idbKey;
        _this.hasIdbKey = _this.idbKey ? true : false;
...
self.addEventListener('idb:worker:initialize', function (e) {
    ...
    db.connect().then(function (m) {
        models = m;
        self.send(true, e.detail.timestamp, e.detail.action);
    }).catch(function (e) {
        return self.send(false, e.detail.timestamp, e.detail.action);
    });
});
...
self.addEventListener('idb:worker:create', function (e) {
    ...
    m.create(e.detail.detail).then(function (result) {
...
self.addEventListener('idb:worker:find', function (e) {
    ...
    m.find(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:createMultiple', function (e) {
    ...
    var m = models[e.detail.model];
    m.createMultiple(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:get', function (e) {
    ...
    m.get(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:first', function (e) {
    ...
    m.first(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (err) {
...
self.addEventListener('idb:worker:update', function (e) {
    ...
    m.update(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:save', function (e) {
    ...
    m.save(e.detail.detail.id, e.detail.detail.data).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:average', function (e) {
    ...
    m.average(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:reduce', function (e) {
    ...
    m.reduce(e.detail.detail.func, e.detail.detail.defaultCarry).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:destroyId', function (e) {
    ...
    m.destroyId(e.detail.detail).then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
...
self.addEventListener('idb:worker:destroy', function (e) {
    ...
    m.destroy().then(function (result) {
        self.send(result, e.detail.timestamp, e.detail.action);
    }).catch(function (er) {
        self.send(er, e.detail.timestamp, e.detail.action + errorNamespace);
    });
